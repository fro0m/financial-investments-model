...
├── financial_investments_model             # The main python package for the project
...
e.g: `cat financial_investments_model/VERSION` will get the project version without harming
